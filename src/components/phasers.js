...
export const PhaserControl = props => {
    const { state: phasers, dispatch } = usePhaser()
    ...
    return (
        <Fragment>
            ...
            <ControlBox>
                <RangeControl min={0} max={500} value={phasers.energy} onInput={e => dispatch({ type: 'store-energy', payload: Number.parseFloat(e.target.value) })} />
